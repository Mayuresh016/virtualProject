...
public class CustBnkmstEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM custbnkmst where custbnkmstid = " + id;
