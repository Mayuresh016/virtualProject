...
public class MstAgencyGroupEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM agencygroup where agencygroupid = " + id;
