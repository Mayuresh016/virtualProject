...
public class MstAgencySubGroupEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM agencysubgroup where agencysubgroupid = " + id;
