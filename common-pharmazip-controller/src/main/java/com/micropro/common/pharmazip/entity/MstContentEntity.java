...
import com.micropro.common.pharmazip.model.generated.MstContentModel.ContentBody;

@Component
public class MstContentEntity {

	private @Autowired ConnectionUtility utility;
	private @Autowired CommonDateFormater formater;

	public String crud(HttpServletRequest request, ContentBody body) throws JsonProcessingException {
		String token = request.getHeader("authorization").split(" ")[1];
		String rightId = request.getHeader("rightId");

		JsonObject obj = formater.serializeObject(body);
		String reqBody = "{\"content\":"  + obj.toString() + "}";
