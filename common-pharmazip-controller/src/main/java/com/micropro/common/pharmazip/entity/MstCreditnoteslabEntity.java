...
public class MstCreditnoteslabEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM creditnoteslab where creditnoteslabid = " + id;
