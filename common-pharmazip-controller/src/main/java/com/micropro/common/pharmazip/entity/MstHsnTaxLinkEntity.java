...
public class MstHsnTaxLinkEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM hsntaxlink where hsntaxlinkid = " + id;
