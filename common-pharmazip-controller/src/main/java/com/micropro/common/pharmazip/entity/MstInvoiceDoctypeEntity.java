...
public class MstInvoiceDoctypeEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM invoicedoctype where invoicedoctypeid = " + id;
