...
public class MstInvoiceseriesEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM invoiceseries where invoiceseriesid = " + id;
