...
public class MstLrentryEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM lrentry where lrentryid = " + id;
