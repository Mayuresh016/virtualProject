...
public class MstPickeruserlinkEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM pickeruserlink where pickeruserlinkid = " + id;
