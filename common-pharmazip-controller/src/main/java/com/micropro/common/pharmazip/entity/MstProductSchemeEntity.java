...
public class MstProductSchemeEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM productscheme where productschemeid = " + id;
