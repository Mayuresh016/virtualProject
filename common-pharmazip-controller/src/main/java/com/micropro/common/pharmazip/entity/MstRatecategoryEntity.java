...
public class MstRatecategoryEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM ratecategory where ratecategoryid = " + id;
