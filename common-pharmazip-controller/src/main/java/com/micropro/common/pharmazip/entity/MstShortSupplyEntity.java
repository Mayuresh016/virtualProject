...
public class MstShortSupplyEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM shortsupply where shortsupplyid = " + id;
