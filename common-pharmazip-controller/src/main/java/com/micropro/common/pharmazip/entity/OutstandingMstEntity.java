...
public class OutstandingMstEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM outstanding where outstandingid = " + id;
