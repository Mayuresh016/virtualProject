...
public class PaymentreceiptMstEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM paymentreceipt where paymentreceiptid = " + id;
