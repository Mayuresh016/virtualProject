...
public class TimeExpiredEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM timeexpired where timeexpiredid = " + id;
