...
public class WorkflowsetupMstEntity {
	...
	public String get(HttpServletRequest request, long id) {
		...
		// Root Entity
		String query = "SELECT * FROM workflowsetup where workflowsetupid = " + id;
