...
public class LedgerMstModel {

	@JsonInclude(Include.ALWAYS)
	@JsonIgnoreProperties(ignoreUnknown = true)
	@ApiModel(description = "A request body model used in POST requests to create a LedgerMst entity")
	public static final class LedgerMstBody {
	...
	public static final class LedgermasterBody {
		...
		private @ApiModelProperty(required = false, value = "REST representation of the 'VOUDATE_BODY'") Date voucherdate;
		private @ApiModelProperty(required = false, value = "REST representation of the 'VOUSERIES_BODY' (Size = 20)") String voucherseries;
		...
		private @ApiModelProperty(required = false, value = "REST representation of the 'LEDGERDETAILID_BODY' (Primary Key)") Long ledgeraccountid;
		...
		public LedgermasterBody(
				...
				@JsonProperty("ledgeraccountid") Long ledgeraccountid,
		...
		public void setFiyearid(Long fiyearid) {
			this.fiyearid = fiyearid;
		}
	...
	public static final class LedgerdetailBody {
		...
		private @ApiModelProperty(required = false, value = "REST representation of the 'VOUCHERMODE_BODY' (Size = 1)") Integer vouchermode;
		private @ApiModelProperty(required = false, value = "REST representation of the 'LEGDDTDISAMT_BODY' (Size = 18,4)") BigDecimal legdtdisamt;
		private @ApiModelProperty(required = false, value = "REST representation of the 'REFERENCEID_BODY' (Size = 20)") Long referenceid;
		...
		public LedgerdetailBody(
				...
				@JsonProperty("vouchermode") Integer vouchermode,
				@JsonProperty("legdtdisamt") BigDecimal legdtdisamt,@JsonProperty("referenceid") Long referenceid) {
			this.orgid = Objects.requireNonNull(orgid, "`orgid` is required");
			this.oprid = Objects.requireNonNull(oprid, "`oprid` is required");
		...
		public BigDecimal getLegdtdisamt() {
			return legdtdisamt;
		}

		public void setLegdtdisamt(BigDecimal legdtdisamt) {
			this.legdtdisamt = legdtdisamt;
		}
	...
	public static final class PaymentreceiptBody {
		...
		private @ApiModelProperty(required = false, value = "REST representation of the 'BILLNO_BODY' (Size = 5)") Integer billinvoiceno;
		private @ApiModelProperty(required = false, value = "REST representation of the 'BILLDATE_BODY'") Date billinvoicedate;
		...
		public PaymentreceiptBody(
				...
				@JsonProperty("billinvoiceno") Integer billinvoiceno,
				@JsonProperty("billinvoicedate") @JsonFormat(pattern = "yyyy-MM-dd") Date billinvoicedate,
		...
		public Integer getBillinvoiceno() {
			return billinvoiceno;
		}

		public void setBillinvoiceno(Integer billinvoiceno) {
			this.billinvoiceno = billinvoiceno;
		}
