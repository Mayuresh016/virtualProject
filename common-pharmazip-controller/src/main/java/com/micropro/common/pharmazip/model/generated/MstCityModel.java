...
public class MstCityModel {
	...
	@ApiModel(description = "A request body model used in POST requests to create a City entity")
	public static final class CityBody {

		private final @ApiModelProperty(required = true, value = "REST representation of the 'ORGID_BODY' (required) (Size = 1)") Integer orgid;
		private @ApiModelProperty(required = false, value = "REST representation of the 'CITYID_BODY' (Primary Key)") Long cityid;
		private final @ApiModelProperty(required = true, value = "REST representation of the 'STATEID_BODY' (required) (Size = 20)") Long stateid;
		private final @ApiModelProperty(required = true, value = "REST representation of the 'TITLE_BODY' (required) (Size = 20)") String title;
		...
		private @ApiModelProperty(required = false, value = "REST representation of the 'ISSEZ_BODY' (Size = 1)") Integer issez;
		...
		public CityBody(
				...
				@JsonProperty("issez") Integer issez,
